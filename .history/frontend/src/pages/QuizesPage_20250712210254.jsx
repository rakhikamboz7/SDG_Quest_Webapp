      ...
      >
        ...
        {!showResult ? (
          <div className="w-full relative">
            {/* Quiz Card - Full opacity, no margin adjustments */}
            <motion.div
              className="w-full bg-white rounded-3xl shadow-xl p-8 relative overflow-visible"
              key={currentQuestion}
          ...
          >
            {/* Completion Teddy - Hiding diagonally */}
