...
import { Target, BookOpen, Award, ChevronRight, CheckCircle2, Search, Bell, ChevronUp, ChevronDown } from "lucide-react"
...
function QuizPage() {
  ...
  const handleQuestionNavigation = (questionIndex) => {
    if (questionIndex <= currentQuestion || selectedOption) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-50">
      ...
      <div className="max-w-8xl mx-auto px-6 py-6">
        <div className="flex gap-5 overflow-scroll">
          {/* Left Sidebar - Goal Roadmap */}
          <div className="w-80 bg-white overflow-y-scroll rounded-2xl shadow-sm border border-gray-200 p-5">
            <div className="mb-6">
            ...
            <div className="space-y-3">
              {Array.from({ length: 17 }, (_, i) => i + 1).map((goal) => {
                const isCompleted = quizScores.some((score) => score.goalId === goal)
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        isCurrent ? "bg-white/20" : isCompleted ? "bg-teal-600" : "bg-gray-200"
                      }`}
                    >
                      {isCompleted ? (
                ...
                {questionsListExpanded && (
                  ...
                  >
                    {quiz?.questions?.map((_, index) => {
                      const isCompleted = index < currentQuestion || (index === currentQuestion && selectedOption)
                      ...
                      return (
                        ...
                        >
                          ...
                          {isCurrent && !selectedOption && <div className="w-2 h-2 bg-teal-600 rounded-full"></div>}
                        </motion.button>
                      )
                    })}
                  </motion.div>
