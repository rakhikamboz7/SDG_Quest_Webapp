 ...
 * }} props
 */
const GrootChatbot = ({ isCorrect, showFeedback, currentQuestion, onAnimationComplete }) => {
  ...
  return (
    <>
      {/* Main Groot Character - Much Larger Size */}
      <div className="fixed bottom-6 right-6 z-50">
        ...
        >
          {/* Groot Image - Larger Size, Natural Shape, Default Green */}
          <motion.div
          ...
          >
            ...
            {/* Chat Indicator */}
            <motion.div
              className="absolute -top-2 -right-2 w-6 h-6 bg-[#005a54] rounded-full flex items-center justify-center cursor-pointer shadow-lg"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.7, 1, 0.7],
              }}
