  ...
  return (
    ...
    >
      ...
      <div className="relative w-64 h-64">
        ...
        {/* Ears */}
        <div className="absolute left-1/4 top-4  w-16 h-16 bg-[#795447] rounded-full border-2 border-[#3E2723] 
                        transform -translate-x-1/2 -translate-y-1/2">
          <div className="absolute left-1/2 top-1/2 w-10 h-10 bg-[#A1887F] rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
        <div className="absolute right-1/4 top-4 w-16 h-16 bg-[#795447] rounded-full border-2 border-[#3E2723] 
                        transform translate-x-1/2 -translate-y-1/2">
          <div className="absolute left-1/2 top-1/2 w-10 h-10 bg-[#A1887F] rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
      </div>
